...
ALTITUDE_WARNING_COLOR: RGBColor = (0.47, 0.65, 1.0)  
GENERIC_WARNING_COLOR: RGBColor = (1, 0, 0)  
PROXIMITY_WARNING_COLOR: RGBColor = (1, 0, 0)  
VELOCITY_WARNING_COLOR: RGBColor = (1, 1, 0)  
ACCELERATION_WARNING_COLOR: RGBColor = (1, 0, 1)  
YAW_WARNING_COLOR: RGBColor = (0, 1, 1)  
