    ...
    def draw(self, context):
        ...
        if entry is not None:
            ...
            if entry.type == "COLOR_RAMP" or entry.type == "IMAGE":
                ...
                elif entry.output == "PRESET":
                    col.prop(entry.output_function, "preset_id", text="Preset")
            ...
            if entry.type == "IMAGE":
                ...
                elif entry.output_y == "PRESET":
                    col.prop(entry.output_function_y, "preset_id", text="Preset")
